...
import { setWelcomeChannel, getWelcomeChannel, setWelcomeMessage, getWelcomeMessage, setLeaveChannel, getLeaveChannel, setLeaveMessage, getLeaveMessage } from '@bot/database';
...
export const welcomeChannelCommand: Command = {
  description,
